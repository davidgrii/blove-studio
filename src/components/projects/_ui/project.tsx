...
export const Project: React.FC<IProps> = ({ project, setIsOpen, index }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className='h-full cursor-pointer group relative border border-border rounded-lg shadow-lg overflow-hidden'
    >
      ...
      <div className='flex px-2.5 py-3 gap-4 justify-between items-center bg-secondary backdrop-blur-lg shadow-lg sm:p-4 lg:p-6 lg:h-full lg:max-h-28 xl:h-fit'>
        ...
        <div className={'flex flex-col'}>
          <h3 className={'text-md font-bold text-white sm:text-lg md:text-xl'}>
            {project.title}
          </h3>
