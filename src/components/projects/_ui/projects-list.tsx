...
export const ProjectsList = () => {
  ...
  return (
    <>
      <div
        className="text-foreground drop-shadow-xl shadow-white/10 border-border bg-card/30 backdrop-blur rounded-lg border shadow-sm">
        <h3
          className="text-2xl text-center p-4 leading-none tracking-tight text-foreground font-semibold sm:p-6 sm:text-3xl">
          All our projects
        </h3>
